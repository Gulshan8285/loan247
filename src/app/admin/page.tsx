...
function exportRows(applications: LoanApplicationRecord[]) {
  return applications.map((application) => ({
    ...
    selectedLoan: application.data.selectedLoanTitle,
    selectedLoanSlug: application.data.selectedLoanSlug,
            ...
            <div className="border-b border-gray-200 bg-emerald-50/40 p-4">
              ...
              <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                {[
                  ...
                  ["Selected loan", selectedApplication.data.selectedLoanTitle || "-"],
